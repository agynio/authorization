...
gRPC authorization service backed by OpenFGA for access checks and policy enforcement.

Architecture: [Authorization](https://github.com/agynio/architecture/blob/main/architecture/authz.md)
